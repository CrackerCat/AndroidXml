...
public class XMLDocument {
    ...
    private Object mLastAttrSorter;
    ...
    public void sortAttributesWithChildes(){
        AttrNameComparator cmp=new AttrNameComparator();
        sortAttributesWithChildes(cmp);
    }
    public void sortAttributesWithChildes(Comparator<XMLAttribute> comparator){
        if(comparator==null){
            return;
        }
        if(mLastAttrSorter !=null){
            if(mLastAttrSorter.getClass().equals(comparator.getClass())){
                return;
            }
        }
        mLastAttrSorter=comparator;
        if(mDocumentElement!=null){
            mDocumentElement.sortAttributesWithChildes(comparator);
        }
    }
    public void setUniqueAttrName(String attrName){
        ...
        docElem.setUniqueAttrName(attrName);
    }
    ...
    public boolean saveAndroidValuesResource(OutputStream out) throws IOException{
        ...
        //hideComments(true);
        sortAttributesWithChildes();
        AttrValuesIDComparator idComparator=new AttrValuesIDComparator();
        sortDocumentElement(idComparator);
